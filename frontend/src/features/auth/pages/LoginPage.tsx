...
function LoginPage() {
  ...
  return (
    <div className="min-h-screen grid place-items-center overflow-hidden bg-[#f7f2e9] px-6 py-10 font-sans">
      <section className="w-full max-w-[420px] rounded-[22px] border border-[#e7dbc9] bg-white px-9 py-10 shadow-[0_18px_48px_rgba(79,58,28,0.08)]">
        <div className="mb-7 text-center">
          <p className="m-0 font-sans text-[42px] font-bold leading-none text-[#17130f]">
            ASENTER
          </p>
          <p className="mt-3 font-sans text-[9px] font-semibold uppercase tracking-[0.24em] text-[#b4a58b]">
